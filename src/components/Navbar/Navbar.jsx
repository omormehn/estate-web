...
const Navbar = () => {
 ...
 useEffect(() => {
  ...
  return (
    <section className="bg-black fixed w-full top-0 overflow-hidden">
      <nav>
        <div className="flexCenter justify-around gap-x-[30vw] ">
          <img
            src="./logo2.png"
          ...
          <div className="list-none  hidden lg:flex lg:flex-row gap-8 text-white">
            ...
            {theme == "dark" ? (
              ...
              <BiSolidMoon className="text-2xl z-50 text-white " onClick={toggleTheme} />
            )}
          </div>
